...
************************************************************************************************************/
	...
	*/	
	...
	function createNewWindow(width,height,left,top)
	{
		...
		img.src = '$STARTrootURL/images/floatingwindow_top_left.gif';
		img.align='left';
		topDiv.appendChild(img);
		
		var img = document.createElement('IMG');
		img.src = '$STARTrootURL/images/floatingwindow_top_center.gif';
		...
		var img = document.createElement('IMG');
		img.src = '$STARTrootURL/images/floatingwindow_minimize.gif';
		img.className='minimizeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = '$STARTrootURL/images/floatingwindow_close.gif';
		img.className='closeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = '$STARTrootURL/images/floatingwindow_top_right.gif';
		buttonDiv.appendChild(img);		
		...
		var img = document.createElement('IMG');
		img.src = '$STARTrootURL/images/floatingwindow_bottom_right.gif';
