...
In addition, we consider RMA CM, besides EDF CM. The ideas in~\cite{key-1} are extended in~\cite{barrosmanaging}, which presents three real-time CM designs. However, no retry bounds or schedulability analysis are presented for those CMs in~\cite{barrosmanaging}. 
...
%%BR: I reworded as "...the set of distinct objects...". Check for accuracy. 
