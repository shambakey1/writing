...
\acmformat{
%Elshambakey, M., Binoy, R. 2012. FBLT.
}

\begin{bottomstuff}
New Paper, Not an Extension of a Conference Paper.\\
%Author's addresses: M. Elshambakey {and} B. Ravindran, ECE Department, Virginia Tech University, Blacksburg, VA 24060, USA.
\end{bottomstuff}
...
By prober adjustment of maximum abort number of each transaction, FBLT schedulability is equal or better than other synchronization techniques. For FBLT's schedulability to be equal or better than lock-free, the upper bound on $s_{max}/r_{max}$ is 1. Upper bound on $s_{max}/r_{max}$ can be higher than 1 if transactions execute in their arrival order and contention is high.
